...
The follow-up form collects optional name and contact number only. Blank fields are submitted as `NA`. If a visitor chooses no future follow-up, name and contact number are both submitted as `NA`.
